...
@injectable()
export class StateMachineGLSPDiagramClient extends GLSPDiagramClient {
    constructor(
        @inject(StateMachineGLSPClientContribution) glspCLientContribution: StateMachineGLSPClientContribution,
