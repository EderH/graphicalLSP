 ...
 * </p>
 * <ul>
 *   <li>{@link com.eclipsesource.glsp.example.statemachine.smgraph.impl.ActivityNodeImpl#getNodeType <em>Node Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActivityNodeImpl extends GNodeImpl implements ActivityNode {
	...
	protected EClass eStaticClass() {
		return SmGraphPackage.Literals.ACTIVITY_NODE;
	}
	...
	public void setNodeType(String newNodeType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmGraphPackage.ACTIVITY_NODE__NODE_TYPE, oldNodeType,
					nodeType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case SmGraphPackage.ACTIVITY_NODE__NODE_TYPE:
			return getNodeType();
		}
